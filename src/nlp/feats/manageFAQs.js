...
const { insertData } = require('../../infrastructure/persistence/database/firebase/firebase-config');
const { readJSONFile, updateJSONFile } = require("../../../recycle/newTrash/utils/jsonReader");
