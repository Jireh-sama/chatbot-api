...
export const FALLBACK_RESPONSE = {
  ...
  social: (subject) =>
    `I’m sorry, I couldn’t find specific information about ${subject}. For updates and official announcements, please visit City Hall’s official Facebook page at <Official Page>{=https://web.facebook.com/CityGovtBacoor=}.`,
};

// Define words/phrases to filter out
export const EXCLUSION_LIST = ["city hall", "bacoor city hall"];
